...
MyBio::RegionCollection::Type::DB - Class for a collection of MyBio::Region objects stored in a database.

=head1 SYNOPSIS

    # Object that corresponds to a collection of MyBio::Region objects.
    # To initialize 
    my $region_collection = MyBio::RegionCollection::DB->new({
        driver      => undef,
        host        => undef,
        database    => undef,
        table       => undef,
...
=head1 DESCRIPTION
    ...
    This class consumes the L<MyBio::RegionCollection> role.
    An object of this class is a collection of objects (records) consuming the L<MyBio::Region>
    ...
    and can handle the records of the database (eg L<MyBio::Data::DB::Alignment::Record>). This
    ...
    of L<MyBio::Region> must exist in the table schema (ie. strand, rname, start, stop,copy_number)
...
package MyBio::RegionCollection::Type::DB;

use Moose;
use namespace::autoclean;

use MyBio::Data::DB::Connector;
...
sub _build_db_connector {
	...
	return MyBio::Data::DB::Connector->new({
		driver   => $self->driver,
		host     => $self->host,
