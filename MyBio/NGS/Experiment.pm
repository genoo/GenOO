...
MyBio::NGS::Experiment - Object describing a Next Generation Sequencing experiment
...
=head1 SYNOPSIS
    ...
    # To initialize 
    my $experiment = MyBio::NGS::Experiment->new({
        NAME            => undef,
        SPECIES         => undef,
        DESCRIPTION     => undef,
        PARAMS          => undef,
...
=head1 EXAMPLES
    ...
    my $experiment_obj = MyBio::NGS::Experiment->read_xml("params.xml);
