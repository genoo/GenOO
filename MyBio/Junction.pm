...
MyBio::Junction - A junction object with features
...
=head1 SYNOPSIS
    ...
    # To initialize 
    my $junction = MyBio::Junction->new({
        SPECIES      => undef,
        STRAND       => undef,
        CHR          => undef,
        START        => undef,
...
=head1 DESCRIPTION
    ...
    The MyBio::Junction class descibes a genomic junction.
