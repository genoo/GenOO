...
GenOO::NGS::Tag - Object that represents an area in the genome

=head1 SYNOPSIS

    # Instantiate 
    my $tag = GenOO::NGS::Tag->new({
        SPECIES      => undef,
        STRAND       => undef,
        CHR          => undef,
        START        => undef,
...
package GenOO::NGS::Tag;
use strict;

use base qw(GenOO::Locus Clone);

# HOW TO INITIALIZE THIS OBJECT
# my $Locus = GenOO::NGS::Tag->new({
# 	SPECIES      => undef,
# 	STRAND       => undef,
# 	CHR          => undef,
# 	START        => undef,
