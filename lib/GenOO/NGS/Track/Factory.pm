...
GenOO::NGS::Track::Factory - Factory for creating GenOO::NGS::Track objects
...
package GenOO::NGS::Track::Factory;
use strict;
...
sub instantiate {
	...
	if (defined $type) {
		my $handler_class_path = 'GenOO/NGS/Track/Factory/'.$type.'.pm';
		my $handler_class = 'GenOO::NGS::Track::Factory::'.$type;
