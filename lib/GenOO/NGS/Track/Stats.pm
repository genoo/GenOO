...
GenOO::NGS::Track::Stats - Object for managing statistics for a GenOO::NGS::Track

=head1 SYNOPSIS

    # Object that offers methods calculating statistics for a GenOO::NGS::Track. 

    # To initialize (NOTE: Should ONLY be instantiated through the track class)
    my $track_stats = GenOO::NGS::Track::Stats->new({
        TRACK            => undef,
    });
