...
GenOO::NGS::Track::Factory::SAM::Tag - Object that offers a GenOO::NGS::Tag interface for GenOO::NGS::Track::Factory::SAM::Record
...
=head1 SYNOPSIS
    ...
    # To initialize 
    my $sam_record_tag = GenOO::NGS::Track::Factory::SAM::Tag->new({
        RECORD       => undef,
        EXTRA_INFO   => undef,
    });
...
=head1 DESCRIPTION
    ...
    This object provides a GenOO::NGS::Tag interface for a record of a sam file and offers methods for accessing the different attributes.
...
package GenOO::NGS::Track::Factory::SAM::Tag;
use strict;
