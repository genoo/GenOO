...
sub next_record : Test(2) {
	...
	isa_ok $self->gff->next_record, 'GenOO::Data::File::GFF::Record', "... and the returned object";
}
...
sub next_record_from_file : Test(2) {
	...
	isa_ok $self->gff->next_record_from_file, 'GenOO::Data::File::GFF::Record', "... and the returned object";
}
...
sub next_record_from_cache : Test(2) {
	...
	isa_ok $self->gff->next_record_from_cache, 'GenOO::Data::File::GFF::Record', "... and the returned object";
}
