package Test::GenOO::NGS::Track::Factory::SAM;
use strict;
...
sub new_object : Test(setup => 1) {
	...
	ok $self->{OBJ} = GenOO::NGS::Track::Factory::SAM->new({
...
sub read_track : Test(3) {
	...
	is $track->records_count, 645, "... and it contains the correct number of tags";
}
