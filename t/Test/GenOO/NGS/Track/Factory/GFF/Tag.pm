package Test::GenOO::NGS::Track::Factory::GFF::Tag;
use strict;
...
sub new_object : Test(setup) {
	...
	my $record = GenOO::Data::File::GFF::Record->new($record_data);
	
	$self->{OBJ} = GenOO::NGS::Track::Factory::GFF::Tag->new({
		RECORD => $record,
	});
};
...
sub record : Test(2) {
	...
	isa_ok $self->obj->record, 'GenOO::Data::File::GFF::Record', "... and returned object";
}
