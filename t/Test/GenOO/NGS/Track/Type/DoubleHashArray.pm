package Test::GenOO::NGS::Track::Type::DoubleHashArray;
use strict;

use Scalar::Util qw(looks_like_number);

use Test::GenOO::NGS::Tag;

use base qw(Test::GenOO::RegionCollection::Type::DoubleHashArray);
use Test::Most;
use Test::Moose;
...
sub _role_check : Test(1) {
	my ($self) = @_;
	does_ok($self->obj(0), 'GenOO::NGS::Track', '... does the GenOO::NGS::Track role');
}
...
sub test_objects {
	...
	my @test_tags = @{Test::GenOO::NGS::Tag->test_objects};
